...
taskForm.addEventListener('submit',(event)=> { //submit to-do 
    ...
    for(let i = 0; i < taskList.length; i++){
        (0,_create_to_do__WEBPACK_IMPORTED_MODULE_0__["default"])(i)
    }
